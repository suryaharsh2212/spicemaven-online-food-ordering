...
function Alerterror({isVisible,message}) {
  ...
  return (
    <div>
      <div role="alert" className={`rounded mt-5 border-s-4 border-red-500 bg-red-50 p-4 ${isVisible}`}>
  ...
  <span className="block">
    <button onClick={()=>dispatch(setshowError('hidden'))} className=""><img className="w-3 h-3" src="https://img.icons8.com/?size=80&id=3QmmTwcR4c2b&format=png" alt="" /></button>
  </span>
</div>
